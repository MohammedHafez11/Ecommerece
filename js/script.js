/*========================
 ...
 window.onload = () => {
  ...
  const btn_close_sidebar = document.getElementById("btn-close-sidebar");
  ...
  // modal
  const pay_btn_modal = document.getElementById("pay-btn-modal");
  const success = document.getElementById("success");
  pay_btn_modal.addEventListener("click", () =>{
